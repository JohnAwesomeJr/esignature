...
INSERT INTO `signers` VALUES (1,'John Christensen','Photagrapher of the greatest veriety','Johnawesomejr@gmail.com','/signatureUploads/61972b1c55bac.svg',2,'2021-11-18'),(2,'jessica Christensen','Client','Johnawesomejr@yahoo.com','/signatureUploads/61972c15bf921.svg',2,'2021-11-18'),(3,'test frank','skippy',NULL,NULL,3,NULL),(4,'other guy','skippy',NULL,NULL,3,NULL),(5,'Jenny Christensen','Record Keeper','kaolla_su@juno.com','/signatureUploads/61972c426bdd0.svg',2,'2021-11-18');
...
INSERT INTO `tags` VALUES (1,1,'location'),(2,1,'price'),(3,1,'service'),(4,2,'other thing');
...
INSERT INTO `template` VALUES (1,'the first template  with a really really long tilte that goes off the screen','this is the content of the first template',1),(2,'another template','template content',1);
...
INSERT INTO `titles` VALUES (1,1,'client'),(2,1,'photographer'),(3,1,'log keeper'),(4,2,'the test');
...
-- Dump completed on 2021-11-19  6:36:03
