...
var convertToBase64 = wrapper.querySelector("[data-action=conBase64]");
...
convertToBase64.addEventListener("click", function (event) {
  if (signaturePad.isEmpty()) {
    alert("Please provide a signature first.");
  } else {
    var dataURL = signaturePad.toDataURL('image/svg+xml');
    ...
    document.getElementById('myTest').innerHTML = dataURL;
    // console.log(dataURL);
  }
});
