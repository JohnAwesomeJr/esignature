...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" src="index_files/rangy-core.js"></script>
    <script type="text/javascript" src="index_files/rangy-selectionsaverestore.js"></script>
...
<body>
    ...
    <div id="buttons">
        ...
        <input id="saveButton" type="button" value="Save selection" unselectable="on" class="unselectable">
        <input id="restoreButton" type="button" value="Restore selection" unselectable="on" class="unselectable" disabled="disabled">
    </div>
    ...
    <div id="content">
        ...
        <pre id="bum" contenteditable="true">Football is the world's most popular sport. It is played in more
